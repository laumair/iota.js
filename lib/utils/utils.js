...
*   Avoid generating hash to boost performance
*
*   @method fastTransactionObject
*   @param {string} hash
*   @param {string} trytes
*   @returns {object} transactionObject
**/
var fastTransactionObject = function(hash, trytes) {
...
module.exports = {
    ...
    fastTransactionObject : fastTransactionObject,
